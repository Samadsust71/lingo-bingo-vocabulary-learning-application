...
const AboutUsPage = () => {
  const projects = [
    { name: "Peddy - Pet Adoption Website", link: "https://pet-website-react.netlify.app" },
    { name: "Chefs Table - Recipe Website", link: "https://chefstable007.netlify.app/" },
    { name: "GadgetHaven - E-commerce Platform", link: "https://gadgetheaven71.netlify.app" },
    { name: "Dragon News - E-news Website", link: "https://dragon-news-d1487.web.app" },
  ];
      ...
      <div className="w-11/12 mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-gray-600 text-center max-w-3xl mx-auto">
            Hi, I'm a passionate front-end developer transitioning to full-stack development. I specialize in
            creating interactive, user-friendly applications. I have experience working on diverse projects and
        ...
        >
          ...
          <div className="flex flex-wrap justify-center items-center gap-6">
            {skills.map((skill, index) => (
              ...
              >
                {skill.icon}
                <span className="mt-4 text-gray-700 font-medium">{skill.name}</span>
              </div>
            ))}
          </div>
        </motion.div>
